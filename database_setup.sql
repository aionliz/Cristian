...
('Daniel Isaias', 'Acevedo', 'Peña', '2007-05-10', 17, 'Fernando Albano', 'danielacevini@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Cristian Patricio', 'Aguirre', 'Parra', '2007-10-03', 17, 'Pasaje el Consulado', 'aguirrecristian2007@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Tomás Justino', 'Alzamora', 'Zorricueta', '2007-09-24', 17, 'José Ghiardo', 'tomas122@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Granja'), 1),
('Emilia Paz', 'Arredondo', 'Contreras', '2007-01-14', 18, 'Sargento Candelaria', 'arredondocontrerasemilia@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Miguel Angel Matías', 'Cabezas', 'Aliaga', '2007-02-07', 18, 'Cadete G Perry', 'miguelangelmca07@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Sofía Carolina', 'Cáceres', 'Durán', '2007-06-08', 17, 'Aurora de Chile', 'sodiacarolinacaceresduran@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Yanira Belén', 'Cayo', 'Cuevas', '2007-12-10', 17, 'Almirante la Torre', 'yaniracayocuevas@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Dailyn', 'Cid', 'Sepulveda', '2007-12-23', 17, 'Javiera Carrera', 'dailyncitamichelle23@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Constanza Belén', 'Concha', 'Venegas', '2007-06-12', 18, 'Gabriela Mistral', 'cbelenconcha@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Cristofer Alejandro', 'Fuentes', 'Manibet', '2008-01-06', 17, 'Futaleufu', 'cristofer.fuentes979@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Lissett Constanza', 'Fuentes', 'Peña', '2008-02-29', 17, 'Jasinto Benavente', 'lissettfuentes27@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Karla Hellen', 'García', 'Guevara', '2006-03-11', 19, 'Tacora', 'karloncha1121@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Granja'), 1),
('Alonso Gabriel', 'Gatica', 'Méndez', '2007-11-07', 17, 'Eugenio Matte Hurtado', 'gabriel.alonso0711@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Tomás Alfredo', 'Gutiérrez', 'Tenorio', '2007-08-15', 17, 'Av. Los Libertadores', 'elias.guerrero.hernandez@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Aileen Yarithza', 'Jara', 'Belmar', '2007-09-09', 17, 'Ismael Tocornal', 'aileen.jara0@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Fernando', 'Jara', 'Delgadillo', '2007-12-03', 17, 'Santa Rosa', 'fernando.jara.delgadillo@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Dayana Arlette', 'Jerez', 'Ríos', '2006-06-10', 18, 'San Juan Bautizta', 'Jeresdayana868@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Juan Diego', 'Medina', 'Pernia', '2007-05-15', 17, 'Vicuña Mackenna', 'juandiego4370@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Cisterna'), 1),
('Giovanni Eduardo', 'Molinet', 'Navarrete', '2007-11-20', 17, 'Los Aromos', 'giovanni.molinet.navarrete@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Brandon Ignacio', 'Morales', 'Aguilar', '2007-08-30', 17, 'Santa Ines de Asis', 'randon.modales.aguila@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Vicente Adolfo', 'Moreno', 'Zapata', '2007-05-26', 17, 'Crecente Errazuriz', 'vicente.adolfo1009@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Benjamín Ignacio', 'Pizarro', 'García', '2007-10-08', 17, 'Cadete G Perry', 'bg301024@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Benjamín Rodrigo', 'Poblete', 'Donoso', '2007-12-31', 17, 'Juan Luis Sanfuentes', 'benjitap098@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Victoria Estefanía', 'Repol', 'Monje', '2008-01-14', 17, 'Francisco Ensinas', 'repol.viky@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Bernardo'), 1),
('Amaro León', 'Rivera', 'Millán', '2007-06-30', 17, 'Baquedano', 'amaritorivera.mati@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Jade Alexandra', 'Rojas', 'Navarro', '2007-09-12', 17, 'Las Flores', 'jade.rojas.navarro@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Diego Benjamín', 'Rojas', 'Palma', '2007-08-09', 17, 'Claro de Luna', 'diego.rojaz.palma@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Mathias Joaquín', 'Rosales', 'Gallegos', '2007-11-16', 17, 'Ismael Tocornal', 'mathiasrosales482@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Bastián Alexander', 'Rubilar', 'Soto', '2007-06-22', 17, 'Ismael Tocornal', 'bastian.rubilar.s@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Davis Alejandro', 'Saldaña', 'González', '2007-05-13', 17, 'Pasaje Los Guindos', 'davis.saskp7@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Renato Antonio', 'Silva', 'Cruz', '2008-03-27', 16, 'Pasaje Cuatro', 'silvacruzrenato18@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Gustavo Alonso', 'Soto', 'Morales', '2007-07-08', 17, 'Los Eucaliptos', 'gustavo.soto.morales@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Pablo Alejandro Andrés', 'Tapia', 'Concha', '2005-08-30', 19, 'Pasaje Cuatro', 'pablotapiaconcha@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Tahía Anaís', 'Terán', 'González', '2008-03-06', 17, 'Sayen', 'tahiateran999@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'La Pintana'), 1),
('Madeline Jazmín', 'Toledo', 'Manríquez', '2007-11-23', 17, 'Eluney Manuel Rodriguez', 'madelinetoledo665@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Constanza Noemí', 'Torres', 'Suazo', '2007-11-17', 17, 'Riquelme', 'constanzatorress@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Alexander Nicolás', 'Uribe', 'Zambrano', '2007-12-25', 17, 'Jose Santos Gonzalez Vera', 'alex.uri2107@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Eyner Alberto', 'Valdez', 'Cifuentes', '2007-02-25', 18, 'Juan Luis Sanfuentes', 'eynervaldez125@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Loreto Ines', 'Vargas', 'Fuentes', '2007-05-21', 17, 'Jacinto benavente', 'magicloreto@gmail.com', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1),
('Fabián Ignacio', 'Vargas', 'Molina', '2007-11-27', 17, 'Los Copihues', 'fabian.vargas.molina@alumnos.sip.cl', (SELECT id_comuna FROM comunas WHERE nombre = 'San Ramon'), 1);
...
CREATE INDEX IF NOT EXISTS idx_asistencias_metodo ON asistencias(metodo_registro);
CREATE INDEX IF NOT EXISTS idx_alumnos_curso ON alumnos(id_curso_fk);
CREATE INDEX IF NOT EXISTS idx_alumnos_activo ON alumnos(activo);
CREATE INDEX IF NOT EXISTS idx_usuarios_rol ON usuarios(rol);
CREATE INDEX IF NOT EXISTS idx_huellas_calidad ON huellas_dactilares(calidad);

-- Crear vista para facilitar consultas de asistencia con información completa
CREATE OR REPLACE VIEW vista_asistencia_completa AS
SELECT 
    a.id_asistencia,
    a.fecha,
    a.estado,
...
CREATE OR REPLACE VIEW vista_estadisticas_huellas AS
SELECT 
...
-- Procedimiento almacenado para obtener resumen de asistencia por fecha
DELIMITER //
CREATE PROCEDURE ObtenerResumenAsistencia(IN fecha_consulta DATE)
BEGIN
    SELECT 
        ...
        SUM(CASE WHEN metodo_registro = 'huella_dactilar' THEN 1 ELSE 0 END) as registros_biometricos,
        SUM(CASE WHEN metodo_registro = 'manual' THEN 1 ELSE 0 END) as registros_manuales,
        ROUND(
            (SUM(CASE WHEN estado IN ('presente', 'tardanza', 'justificado') THEN 1 ELSE 0 END) / COUNT(*)) * 100, 2
...
-- Función para calcular porcentaje de asistencia de un alumno en un período
DELIMITER //
CREATE FUNCTION CalcularPorcentajeAsistenciaAlumno(
    p_id_alumno INT, 
    p_fecha_inicio DATE, 
    p_fecha_fin DATE
) RETURNS DECIMAL(5,2)
...
BEGIN
    ...
    DECLARE dias_efectivos INT DEFAULT 0;
    DECLARE porcentaje DECIMAL(5,2) DEFAULT 0;
    
    SELECT COUNT(*) INTO total_dias
    FROM asistencias 
    WHERE id_alumno = p_id_alumno 
    AND fecha BETWEEN p_fecha_inicio AND p_fecha_fin;
    
    SELECT COUNT(*) INTO dias_efectivos
    FROM asistencias 
    WHERE id_alumno = p_id_alumno 
    AND fecha BETWEEN p_fecha_inicio AND p_fecha_fin
    AND estado IN ('presente', 'tardanza', 'justificado');
    
    IF total_dias > 0 THEN
        SET porcentaje = (dias_efectivos / total_dias) * 100;
    END IF;
...
-- Función para obtener el total de alumnos sin huella registrada
DELIMITER //
CREATE FUNCTION AlumnosSinHuella() RETURNS INT
READS SQL DATA
DETERMINISTIC
BEGIN
    DECLARE total_sin_huella INT DEFAULT 0;
    
    SELECT COUNT(*) INTO total_sin_huella
    FROM alumnos a
    LEFT JOIN huellas_dactilares h ON a.id_alumno = h.id_alumno AND h.activa = 1
    WHERE a.activo = 1 AND h.id_huella IS NULL;
    
    RETURN total_sin_huella;
END //
DELIMITER ;
